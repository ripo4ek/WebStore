...
namespace WebStore.ViewComponents
{
    public class SectionsViewComponent : ViewComponent
    {
        ...
        private List<SectionViewModel> GetSections()
        {
            ...
            var parentCategories = categories.Where(p => !p.ParentId.HasValue).ToArray(); var parentSections = new List<SectionViewModel>();
            ...
            parentSections = parentSections.OrderBy(c => c.Order).ToList(); return parentSections;
        }
